...
class Precondition0 extends Precondition
{
	...
	public Precondition0(Term[] unifier)
	{
		...
		p[1] = new PreconditionNegation(new PreconditionAtomic(new Predicate(5, 3, new TermList(TermVariable.getVariable(0), TermList.NIL)), unifier), 3);
		p[2] = new PreconditionAtomic(new Predicate(3, 3, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), TermList.NIL))), unifier);
		p[3] = new PreconditionAtomic(new Predicate(4, 3, new TermList(new TermList(TermConstant.getConstant(3), new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(2), TermList.NIL))), TermList.NIL)), unifier);
		p[4] = new PreconditionNegation(new PreconditionAtomic(new Predicate(6, 3, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(2), TermList.NIL))), unifier), 3);
		p[5] = new PreconditionAtomic(new Predicate(0, 3, new TermList(TermVariable.getVariable(2), TermList.NIL)), unifier);
		p[6] = new PreconditionNegation(new PreconditionAtomic(new Predicate(7, 3, new TermList(TermVariable.getVariable(2), TermList.NIL)), unifier), 3);
		b = new Term[7][];
...
class Precondition1 extends Precondition
{
	...
	public Precondition1(Term[] unifier)
	{
		...
		p[1] = new PreconditionNegation(new PreconditionAtomic(new Predicate(5, 3, new TermList(TermVariable.getVariable(0), TermList.NIL)), unifier), 3);
		p[2] = new PreconditionAtomic(new Predicate(3, 3, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), TermList.NIL))), unifier);
		p[3] = new PreconditionAtomic(new Predicate(4, 3, new TermList(new TermList(TermConstant.getConstant(1), new TermList(TermVariable.getVariable(0), TermList.NIL)), TermList.NIL)), unifier);
		b = new Term[4][];
...
class Precondition2 extends Precondition
{
	...
	public Precondition2(Term[] unifier)
	{
		...
		p[3] = new PreconditionAtomic(new Predicate(4, 3, new TermList(new TermList(TermConstant.getConstant(3), new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), TermList.NIL))), TermList.NIL)), unifier);
		p[4] = new PreconditionAtomic(new Predicate(0, 3, new TermList(TermVariable.getVariable(1), TermList.NIL)), unifier);
		p[5] = new PreconditionNegation(new PreconditionAtomic(new Predicate(7, 3, new TermList(TermVariable.getVariable(1), TermList.NIL)), unifier), 3);
		b = new Term[6][];
...
class Precondition3 extends Precondition
{
	...
	public Precondition3(Term[] unifier)
	{
		...
		p[1] = new PreconditionNegation(new PreconditionAtomic(new Predicate(5, 3, new TermList(TermVariable.getVariable(0), TermList.NIL)), unifier), 3);
		p[2] = new PreconditionAtomic(new Predicate(3, 3, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), TermList.NIL))), unifier);
		p[3] = new PreconditionAtomic(new Predicate(7, 3, new TermList(TermVariable.getVariable(0), TermList.NIL)), unifier);
		b = new Term[4][];
...
class Precondition4 extends Precondition
{
	...
	public Precondition4(Term[] unifier)
	{
		...
		p[0] = new PreconditionAtomic(new Predicate(3, 4, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), TermList.NIL))), unifier);
		p[1] = new PreconditionAtomic(new Predicate(4, 4, new TermList(new TermList(TermConstant.getConstant(3), new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(2), TermList.NIL))), TermList.NIL)), unifier);
		p[2] = new PreconditionNegation(new PreconditionAtomic(new Predicate(6, 4, new TermList(TermVariable.getVariable(1), new TermList(TermVariable.getVariable(2), TermList.NIL))), unifier), 4);
		b = new Term[3][];
...
class Precondition5 extends Precondition
{
	...
	public Precondition5(Term[] unifier)
	{
		...
		p[0] = new PreconditionAtomic(new Predicate(1, 4, new TermList(TermVariable.getVariable(0), TermList.NIL)), unifier);
		p[1] = new PreconditionAtomic(new Predicate(4, 4, new TermList(new TermList(TermConstant.getConstant(3), new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(2), TermList.NIL))), TermList.NIL)), unifier);
		b = new Term[2][];
...
class Precondition6 extends Precondition
{
	...
	public Precondition6(Term[] unifier)
	{
		p = new Precondition[2];
		p[0] = new PreconditionAtomic(new Predicate(3, 4, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), TermList.NIL))), unifier);
		p[1] = new PreconditionAtomic(new Predicate(4, 4, new TermList(new TermList(TermConstant.getConstant(1), new TermList(TermVariable.getVariable(0), TermList.NIL)), TermList.NIL)), unifier);
		b = new Term[2][];
...
class Precondition7 extends Precondition
{
	...
	public Precondition7(Term[] unifier)
	{
		p = new Precondition[2];
		p[0] = new PreconditionAtomic(new Predicate(3, 4, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), TermList.NIL))), unifier);
		p[1] = new PreconditionAtomic(new Predicate(4, 4, new TermList(new TermList(TermConstant.getConstant(0), new TermList(TermVariable.getVariable(1), TermList.NIL)), TermList.NIL)), unifier);
		b = new Term[2][];
...
class Precondition8 extends Precondition
{
	...
	{
		p = new Precondition[3];
		p[0] = new PreconditionAtomic(new Predicate(3, 4, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(2), TermList.NIL))), unifier);
		p[1] = new PreconditionAtomic(new Predicate(4, 4, new TermList(new TermList(TermConstant.getConstant(3), new TermList(TermVariable.getVariable(1), new TermList(TermVariable.getVariable(2), TermList.NIL))), TermList.NIL)), unifier);
		p[2] = new PreconditionNegation(new PreconditionAtomic(new Predicate(6, 4, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), TermList.NIL))), unifier), 4);
		b = new Term[3][];
...
class Precondition9 extends Precondition
{
	...
	{
		p = new Precondition[2];
		p[0] = new PreconditionAtomic(new Predicate(3, 4, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(3), TermList.NIL))), unifier);
		p[1] = new PreconditionAtomic(new Predicate(7, 4, new TermList(TermVariable.getVariable(3), TermList.NIL)), unifier);
		b = new Term[2][];
...
public class oldblocks extends Domain
{
	...
	private void computeUtilities(Method[][] methods)
	{
