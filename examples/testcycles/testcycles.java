...
class Method2 extends Method
{
	...
	TaskList createTaskList0()
	{
		...
		retVal.subtasks[0] = new TaskList(new TaskAtom(new Predicate(1, 3, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(2), TermList.NIL))), false, true));
...
public class testpreprocessingmodifiedcycles2 extends Domain
{
	public testpreprocessingmodifiedcycles2()
	{
