...
class Method4 extends Method
{
	...
	TaskList createTaskList0()
	{
		...
		retVal = new TaskList(1, true);
		retVal.subtasks[0] = new TaskList(new TaskAtom(new Predicate(2, 2, new TermList(TermVariable.getVariable(1), new TermList(TermVariable.getVariable(0), TermList.NIL))), false, false));
	...
	public Precondition getIterator(Term[] unifier, int which)
	{
		...
		{
			case 0:
				p = (new PreconditionAtomic(new Predicate(0, 2, new TermList(TermVariable.getVariable(1), TermList.NIL)), unifier)).setComparator(null);
			break;
			default:
				return null;
		}
...
class Method5 extends Method
{
	public Method5()
	{
		super(new Predicate(2, 2, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), TermList.NIL))));
		TaskList[] subsIn = new TaskList[1];
	...
	TaskList createTaskList0()
	{
		...
		retVal = new TaskList(1, true);
		retVal.subtasks[0] = new TaskList(new TaskAtom(new Predicate(0, 2, new TermList(new TermNumber(100.0), TermList.NIL)), false, false));
...
class Precondition4 extends Precondition
{
	...
	public Precondition4(Term[] unifier)
	{
		...
		p[1] = new PreconditionAtomic(new Predicate(7, 3, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(2), TermList.NIL))), unifier);
		b = new Term[2][];
...
class Method6 extends Method
{
	...
	TaskList createTaskList0()
	{
		...
		retVal.subtasks[0] = new TaskList(new TaskAtom(new Predicate(1, 3, new TermList(TermVariable.getVariable(2), TermList.NIL)), false, false));
		retVal.subtasks[1] = new TaskList(new TaskAtom(new Predicate(0, 3, new TermList(new TermNumber(10.0), TermList.NIL)), false, false));
...
class Axiom2 extends Axiom
{
	public Axiom2()
	{
		super(new Predicate(7, 3, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), TermList.NIL))), 2);
	}
...
public class myexample extends Domain
{
	public myexample()
	{
		...
		constants[0] = "at";
		constants[1] = "have-cash";
		constants[2] = "walking-distance";
		constants[3] = "at-taxi-stand";
		constants[4] = "distance";
		constants[5] = "have-taxi-fare";
		constants[6] = "bus-route";
		constants[7] = "short-distance";
		constants[8] = "good";
		constants[9] = "weather-is";

		compoundTasks = new String[3];
		compoundTasks[0] = "pay-driver";
		compoundTasks[1] = "travel-to";
		compoundTasks[2] = "get-tickets";

		primitiveTasks = new String[6];
		primitiveTasks[0] = "!hail";
		primitiveTasks[1] = "!wait-for";
		primitiveTasks[2] = "!ride";
		primitiveTasks[3] = "!set-cash";
		primitiveTasks[4] = "!walk";
		primitiveTasks[5] = "!fly";
