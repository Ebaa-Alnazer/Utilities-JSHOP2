package utilities.jshop2.testpreprocessingmodified;
...
class Method3 extends Method
{
	...
	TaskList createTaskList0()
	{
		...
		retVal.subtasks[1] = new TaskList(new TaskAtom(new Predicate(0, 3, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), TermList.NIL))), false, true));
...
public class testpreprocessingmodified extends Domain
{
	public testpreprocessingmodified()
	{
