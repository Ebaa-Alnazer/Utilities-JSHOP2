package utilities.jshop2.testcyclesbigexample;
...
class Operator0 extends Operator
{
	public Operator0()
	{
		super(new Predicate(0, 2, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), TermList.NIL))), -1, -1, new TermNumber(14.0));
...
class Operator1 extends Operator
{
	public Operator1()
	{
		super(new Predicate(1, 2, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), TermList.NIL))), -1, -1, new TermNumber(20.0));
...
class Operator2 extends Operator
{
	public Operator2()
	{
		super(new Predicate(2, 2, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), TermList.NIL))), -1, -1, new TermNumber(2.0));
...
class Method0 extends Method
{
	...
	TaskList createTaskList0()
	{
		...
		retVal.subtasks[0] = new TaskList(new TaskAtom(new Predicate(0, 2, new TermList(TermVariable.getVariable(1), new TermList(TermVariable.getVariable(0), TermList.NIL))), false, true));
		...
		retVal.subtasks[2] = new TaskList(new TaskAtom(new Predicate(1, 2, new TermList(TermVariable.getVariable(1), new TermList(new TermCall(new List(TermVariable.getVariable(1), new TermList(TermVariable.getVariable(0), TermList.NIL)), StdLib.minus, "StdLib.minus"), TermList.NIL))), false, true));
...
class Method2 extends Method
{
	...
	TaskList createTaskList0()
	{
		...
		retVal.subtasks[0] = new TaskList(new TaskAtom(new Predicate(2, 3, new TermList(TermVariable.getVariable(2), TermList.NIL)), false, false));
		retVal.subtasks[1] = new TaskList(new TaskAtom(new Predicate(0, 3, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(2), TermList.NIL))), false, true));
...
class Method5 extends Method
{
	...
	TaskList createTaskList0()
	{
		...
		retVal = new TaskList(2, true);
		retVal.subtasks[0] = new TaskList(new TaskAtom(new Predicate(3, 2, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), TermList.NIL))), false, false));
...
class Method7 extends Method
{
	...
	TaskList createTaskList0()
	{
		...
		retVal = new TaskList(2, true);
		retVal.subtasks[0] = new TaskList(new TaskAtom(new Predicate(2, 2, new TermList(TermVariable.getVariable(0), TermList.NIL)), false, false));
		retVal.subtasks[1] = new TaskList(new TaskAtom(new Predicate(0, 2, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), TermList.NIL))), false, true));
...
class Precondition7 extends Precondition
{
	...
	{
		p = new Precondition[2];
		p[0] = new PreconditionAtomic(new Predicate(6, 2, new TermList(TermVariable.getVariable(1), TermList.NIL)), unifier);
...
class Precondition8 extends Precondition
{
	...
	public Precondition8(Term[] unifier)
	{
		...
		p[0] = new PreconditionAtomic(new Predicate(8, 3, new TermList(TermConstant.getConstant(7), TermList.NIL)), unifier);
		p[1] = new PreconditionAtomic(new Predicate(9, 3, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), new TermList(TermVariable.getVariable(2), TermList.NIL)))), unifier);
...
class Precondition9 extends Precondition
{
	...
	{
		p = new Precondition[2];
		p[0] = new PreconditionAtomic(new Predicate(9, 3, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), new TermList(TermVariable.getVariable(2), TermList.NIL)))), unifier);
...
public class testcyclesbigexample extends Domain
{
	public testcyclesbigexample()
	{
		...
		constants[5] = "have-t";
		constants[6] = "have-cash";
		constants[7] = "good";
		constants[8] = "weather-is";
		constants[9] = "distance";
		...
		methods[2][0] = new Method5();
		methods[2][1] = new Method6();

		methods[3] = new Method[2];
		methods[3][0] = new Method7();
		methods[3][1] = new Method8();
