package utilities.jshop2.basicModified;
...
class Operator0 extends Operator
{
	public Operator0()
	{
		super(new Predicate(0, 1, new TermList(TermVariable.getVariable(0), TermList.NIL)), -1, -1, new TermNumber(2.0));
...
public class basicModified extends Domain
{
	public basicModified()
	{
